...
export const RankingPage = () => {
  ...
  const currentUserPosition = rankings.find(
    (r) => r.user_id === user?.id
  )?.position;
      ...
      <div className="container mx-auto px-4 max-w-4xl space-y-6">
        ...
        >
          ...
          <p className="text-muted-foreground">
            Veja onde você está entre os melhores leitores
            da plataforma
          </p>
        </motion.div>
        ...
        >
          <Tabs
            value={activeTab}
            onValueChange={(value) =>
              setActiveTab(value as RankingType)
            }
          >
                      ...
                      <AnimatePresence>
                        {isLoading ? (
                          ...
                          >
                            ...
                            <p className="text-muted-foreground">
                              Os rankings aparecerão
                              conforme os usuários começarem
                              a ler
                            </p>
                          </motion.div>
                        ) : (
