...
const EnhancedSocialSection: React.FC = () => {
  ...
  } = usePublicProfiles(10);
  const { data: searchResults = [] } =
    usePublicUserSearch(searchTerm);
  const {
    data: leaderboard = [],
    ...
    <div className="container mx-auto p-4 space-y-6">
      ...
      >
        ...
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Descubra o que outros leitores estão fazendo,
          conecte-se com a comunidade e acompanhe suas
                  ...
                  >
                    ...
                    <div className="text-left">
                      ...
                      <p className="text-xs text-muted-foreground">
                        ...
                        {profile.books_completed} livros
                      </p>
                    </div>
                  </Button>
                ))}
      ...
      >
            ...
            <CardContent>
              {feedLoading ? (
                ...
                <div className="text-center py-8 text-muted-foreground">
                  ...
                  <p className="text-sm">
                    Complete livros e desbloqueie conquistas
                    para aparecer aqui!
                  </p>
                </div>
              ) : (
        ...
        <TabsContent value="ranking" className="space-y-4">
          <Card>
            ...
            <CardContent>
              {/* Only fetch and render ranking when the tab is selected to save resources */}
              {selectedTab !== "ranking" ? (
                <div className="text-sm text-muted-foreground">
                  Abra o ranking para carregar dados.
                </div>
              ) : leaderboardLoading ? (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-4 text-xs text-muted-foreground">
                          ...
                          <span>
                            {user.books_completed} livros
                          </span>
                          <span>
                            {user.total_pages_read} páginas
                          </span>
                        </div>
                      </div>
