  ...
  const addTestBook = async () => {
    ...
    try {
      ...
      if (error) {
        ...
        toast({
          title: "Erro",
          description: "Não foi possível adicionar o livro de teste",
          variant: "destructive",
        });
        return;
      }
      ...
      if (profile) {
        await supabase
          ...
          .update({
            ...
            total_pages_read: (profile.total_pages_read || 0) + 200,
          })
          .eq("user_id", user.id);
      }
    ...
    <Card className="mb-6 border-dashed border-2 border-orange-200 bg-orange-50">
      <CardHeader>
        ...
        <CardDescription className="text-orange-600">
          Use estes botões para testar o sistema de conquistas e feed de atividades
        </CardDescription>
      </CardHeader>
